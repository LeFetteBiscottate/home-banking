...
CREATE TABLE IF NOT EXISTS `mydb`.`bank` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NOT NULL,
  `filiale_description` VARCHAR(255) NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `_idx` (`filiale_description` ASC),
  CONSTRAINT `bank_fk`
    FOREIGN KEY (`filiale_description`)
